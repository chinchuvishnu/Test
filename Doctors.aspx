...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DoctorConnectionString %>" SelectCommand="SELECT [Name], [id], [Department] FROM [Doctors]"></asp:SqlDataSource>
    </div>
    </form>
</body>
</html>
